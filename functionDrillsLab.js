...
// console.log(printName("Kirsten"))
// console.log(printName1("Kirsten"))
...
// console.log(exclaimThree("Cheese"))
...
// let namesArr2 = ['Kirsten', 'Darianne']
/*
...
// console.log(emailCheck("      kirsten@devmountain.com"))
////////////////// PROBLEM 19 ////////////////////
/*
...
/*
  ...
  Re-write the function you used in the previous problem (give it the same name, just add a 2 to the end of it) that fixes this bug. Invoke the function and store the returned value to a variable called `totalFrogs2`.
*/

function goldSpent2(gold){
  const chocoFrogCost = 3
  return (parseInt(gold / chocoFrogCost))
}

totalFrogs2 = goldSpent2(10)
...
let arrayIsAscending = numArr(sampleArray2)
